...
Route::get('getIncomeKasir', [DashboardController::class, 'getIncomeKasir'])->name('getIncomeKasir');
Route::post('getGrafikByKasir', [DashboardController::class, 'getGrafikByKasir'])->name('getGrafikByKasir');
